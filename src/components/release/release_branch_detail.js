    ...
    render() {
        ...
        return (
            <div>
                ...
                {!this.state.loading_cards && <Title style={{paddingLeft: "40px", paddingTop: "40px"}} level={4}><Text
                    code>{"Current Advisories"}</Text></Title>}
                ...
                {!this.state.loading_cards &&
                    <RELEASE_BRANCH_DETAIL_TABLE data={this.state.advisory_details_previous}/>}
            </div>
        )
    }
